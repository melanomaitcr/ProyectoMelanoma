...
@Component({
  selector: 'app-expediente-registro-confirmacion',
  templateUrl: './expediente-registro-confirmacion.component.html',
  styleUrls: ['./expediente-registro-confirmacion.component.scss']
})
export class ExpedienteRegistroConfirmacionComponent implements OnInit {
  ...
  constructor(private expedienteService: ExpedienteService,
    ...
    public referenciaDialogo: MatDialogRef<ExpedienteRegistroConfirmacionComponent>,
