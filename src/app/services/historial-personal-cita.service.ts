...
//const baseUrl = 'http://melanomaitcr.pythonanywhere.com/api/historialPersonalCita';
const baseUrl = window.location.origin + '/api/historialPersonalCita';

@Injectable({
  providedIn: 'root'
})
export class HistorialPersonalCitaService {
