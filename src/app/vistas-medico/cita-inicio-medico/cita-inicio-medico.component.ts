...
@Component({
  selector: 'app-cita-inicio-medico',
  templateUrl: './cita-inicio-medico.component.html',
  styleUrls: ['./cita-inicio-medico.component.scss']
})
export class CitaInicioMedicoComponent implements OnInit {
  ...
  constructor(private citaService: CitaService,
    ...
    public referenciaDialogo: MatDialogRef<CitaInicioMedicoComponent>,
