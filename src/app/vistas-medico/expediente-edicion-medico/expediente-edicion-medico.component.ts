...
@Component({
  selector: 'app-expediente-edicion-medico',
  templateUrl: './expediente-edicion-medico.component.html',
  styleUrls: ['./expediente-edicion-medico.component.scss']
})
export class ExpedienteEdicionMedicoComponent implements OnInit {
  ...
  constructor(private expedienteService: ExpedienteService,
    ...
    public referenciaDialogo: MatDialogRef<ExpedienteEdicionMedicoComponent>,
