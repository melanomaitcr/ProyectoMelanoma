...
@Component({
  selector: 'app-expediente-registro-confirmacion-asistente',
  templateUrl: './expediente-registro-confirmacion-asistente.component.html',
  styleUrls: ['./expediente-registro-confirmacion-asistente.component.scss']
})
export class ExpedienteRegistroConfirmacionAsistenteComponent implements OnInit {
  ...
  constructor(private expedienteService: ExpedienteService,
    ...
    public referenciaDialogo: MatDialogRef<ExpedienteRegistroConfirmacionAsistenteComponent>,
