...
@Component({
  selector: 'app-cita-registro-asistente',
  templateUrl: './cita-registro-asistente.component.html',
  styleUrls: ['./cita-registro-asistente.component.scss']
})
export class CitaRegistroAsistenteComponent implements OnInit {
  ...
  constructor(
    ...
    public referenciaDialogo: MatDialogRef<CitaRegistroAsistenteComponent>,
