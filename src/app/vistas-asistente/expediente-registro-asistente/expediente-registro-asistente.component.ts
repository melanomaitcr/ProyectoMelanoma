...
@Component({
  selector: 'app-expediente-registro-asistente',
  templateUrl: './expediente-registro-asistente.component.html',
  styleUrls: ['./expediente-registro-asistente.component.scss']
})
export class ExpedienteRegistroAsistenteComponent implements OnInit {
  ...
  constructor(private expedienteService: ExpedienteService,
    ...
    public referenciaDialogo: MatDialogRef<ExpedienteRegistroAsistenteComponent>,
