...
@Component({
  selector: 'app-cita-visualizacion-asistente',
  templateUrl: './cita-visualizacion-asistente.component.html',
  styleUrls: ['./cita-visualizacion-asistente.component.scss']
})
export class CitaVisualizacionAsistenteComponent implements OnInit {
  ...
  constructor(private citaService: CitaService,
    ...
    public referenciaDialogo: MatDialogRef<CitaVisualizacionAsistenteComponent>,
