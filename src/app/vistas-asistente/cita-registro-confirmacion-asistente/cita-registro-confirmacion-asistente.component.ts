...
@Component({
  selector: 'app-cita-registro-confirmacion-asistente',
  templateUrl: './cita-registro-confirmacion-asistente.component.html',
  styleUrls: ['./cita-registro-confirmacion-asistente.component.scss']
})
export class CitaRegistroConfirmacionAsistenteComponent implements OnInit {
  idCita: String;
  cita: Cita = new Cita("", "", "", "", "", "", "", "", "");
  citaData = {
    nombrePaciente: "",
  ...
  constructor(private citaService: CitaService,
    ...
    public referenciaDialogo: MatDialogRef<CitaRegistroConfirmacionAsistenteComponent>,
